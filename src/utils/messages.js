...
function introMessage() {
  return [
    ...
    "• /learnall — режим обучения со всеми вопросами в случайном порядке",
    ...
    "• В /learn доступны кнопки: Подсказка (3 уровня), Перевести (полный перевод) и Показать ответ.",
...
function formatDailyReminder(activeSession) {
  ...
  return [
    ...
    "• /learnall — начать обучение со всеми вопросами в случайном порядке",
