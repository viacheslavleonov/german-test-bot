...
function buildHintInstructionByLevel(level) {
  if (level <= 1) {
    return [
      ...
      "Сделай только легкую подсказку: перепиши оригинальный немецкий вопрос и добавь короткие русские переводы ключевых слов в скобках.",
      "Добавь краткие подсказки по вариантам ответа: для каждого варианта дай 1 короткую русскую расшифровку ключевой идеи.",
      "Не указывай правильный ответ и не ранжируй варианты по вероятности.",
      "Формат: 1 строка с вопросом + блок 'Варианты (кратко): 1)... 2)... 3)... 4)...'.",
    ].join("\n");
  }
